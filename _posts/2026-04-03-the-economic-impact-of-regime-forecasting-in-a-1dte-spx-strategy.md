...
All the experiments and charts are generated using this [notebook](https://github.com/jwplatta/trade_lab/blob/main/notebooks/shared/SPX-1DTE-Forecasting-Regime.ipynb) and the data you can find [here](https://github.com/jwplatta/trade_lab/tree/main/notebooks/shared/data).
## Experimental Setup
