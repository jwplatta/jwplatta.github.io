...
Full notebook with code for EV calculations and to build the IV surface model along with the sampled options data can be found [here](https://github.com/jwplatta/portfolio-research/blob/main/notebooks/shared/ironcondor-ev-calculations.ipynb).