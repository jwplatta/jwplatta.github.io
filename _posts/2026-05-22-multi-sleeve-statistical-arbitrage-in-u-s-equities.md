...
The full report is [here](https://github.com/jwplatta/portfolio-research/blob/main/reports/jwplatta_multi_sleeve_stat_arb_us_equities.pdf) and the code for producing the results is [here](https://github.com/jwplatta/portfolio-research/blob/main/notebooks/multi-sleeve-us-equities-stat-arb-qstudy.ipynb).
