...
A notebook with these calculations and the results can be found [here](https://github.com/jwplatta/portfolio-research/blob/main/notebooks/shared/spx-short-term-iv-rv-spread.ipynb) along with the data [here](https://github.com/jwplatta/portfolio-research/blob/main/notebooks/shared/data).
